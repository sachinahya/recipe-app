...
import { RecipeSingleQuery } from 'features/recipes/queries.generated';
...
export interface RecipeSingleProps {
  // This could be made non-nullable so that we can show stuff during the loading state.
  recipe: NonNullable<RecipeSingleQuery['recipe']>;
}
