...
export type RecipesQuery = { __typename?: 'Query', recipes: Array<{ __typename?: 'Recipe', id: number, title: string, description?: Types.Maybe<string>, totalTime: number, images?: Types.Maybe<Array<{ __typename?: 'ImageMeta', url: string }>>, categories: Array<{ __typename?: 'Category', name: string }> }> };
