...
export type IngredientFieldsFragment = { __typename?: 'Ingredient', id: number, quantity: number, measure?: Types.Maybe<string>, item: string };

export type StepFieldsFragment = { __typename?: 'Step', id: number, description: string };

export type ImageFieldsFragment = { __typename?: 'ImageMeta', id: string, caption?: Types.Maybe<string>, url: string, order: number };
...
export type RecipeFieldsFragment = { __typename?: 'Recipe', id: number, title: string, description?: Types.Maybe<string>, sourceUrl?: Types.Maybe<string>, prepTime?: Types.Maybe<number>, cookTime?: Types.Maybe<number>, totalTime: number, yield?: Types.Maybe<number>, images?: Types.Maybe<Array<(
