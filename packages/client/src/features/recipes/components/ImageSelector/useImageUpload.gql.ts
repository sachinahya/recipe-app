...
export type RequestUploadMutation = { __typename?: 'Mutation', requestUpload: { __typename?: 'SignedUploadRequest', expires: number, filename: string, signedUrl: string } };
...
export function useRequestUploadMutation() {
  return Urql.useMutation<RequestUploadMutation, RequestUploadMutationVariables>(RequestUploadDocument);
};