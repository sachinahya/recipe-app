...
export type SaveRecipeMutation = { __typename?: 'Mutation', addRecipe: (
    { __typename?: 'Recipe' }
...
export type RecipeFormDataQuery = { __typename?: 'Query', recipe?: Types.Maybe<(
    { __typename?: 'Recipe' }
    & RecipeFieldsFragment
  )> };
...
export function useRecipeFormDataQuery(options: Omit<Urql.UseQueryArgs<RecipeFormDataQueryVariables>, 'query'> = {}) {
