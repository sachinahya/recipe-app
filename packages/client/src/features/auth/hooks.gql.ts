...
export type CurrentUserQuery = { __typename?: 'Query', currentUser?: Types.Maybe<{ __typename?: 'User', email: string }> };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'User', email: string } };
